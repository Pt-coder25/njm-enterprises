...
import type { BodyType as _BodyType, Cell as _Cell, Condition as _Condition, Error as _Error, Result as _Result, Result__1 as _Result__1, UserRole as _UserRole, Value as _Value, Vehicle as _Vehicle } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async listVehiclesByMake(arg0: string): Promise<Array<Vehicle>> {
        if (this.processError) {
            try {
                const result = await this.actor.listVehiclesByMake(arg0);
                return from_candid_vec_n25(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_BodyType_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _BodyType): BodyType {
...
function from_candid_Condition_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Condition): Condition {
...
function from_candid_Vehicle_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Vehicle): Vehicle {
...
function from_candid_opt_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Vehicle]): Vehicle | null {
    return value.length === 0 ? null : from_candid_Vehicle_n18(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_record_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        bodyType: from_candid_BodyType_n21(_uploadFile, _downloadFile, value.bodyType),
        condition: from_candid_Condition_n23(_uploadFile, _downloadFile, value.condition),
...
function from_candid_variant_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "SUV" in value ? BodyType.SUV : "Van" in value ? BodyType.Van : "Sedan" in value ? BodyType.Sedan : "Wagon" in value ? BodyType.Wagon : "Hatchback" in value ? BodyType.Hatchback : "Coupe" in value ? BodyType.Coupe : value;
}
function from_candid_variant_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "Roro" in value ? Condition.Roro : "BrandNew" in value ? Condition.BrandNew : value;
}
...
function from_candid_vec_n25(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Vehicle>): Array<Vehicle> {
    return value.map((x)=>from_candid_Vehicle_n18(_uploadFile, _downloadFile, x));
}
